...
void main() {
  ...
  group('City', (){
    ...
    test('aarePreciceTemperature', () => expect(city().aarePreciceTemperature, 8.29));
    test('weatherSymbol', () => expect(city().weatherSymbol, '10'));
    test('dailyMinimumAirTemperature', () => expect(city().dailyMinimumAirTemperature, 14));
    test('dailyMaximumAirTemperature', () => expect(city().dailyMaximumAirTemperature, 21));
    test('forecast', () => expect(city().forecast, false));
    test('time', () => expect(city().time, DateTime(2024,8,19,22,20,0)));
    test('url', () => expect(city().url, Uri.parse('https://aareguru.existenz.ch/v2018/current?city=brienz')));
    test('today', () => expect(city().today, Uri.parse('https://aareguru.existenz.ch/v2018/today?city=brienz')));
    test('widget', () => expect(city().widget, Uri.parse('https://aareguru.existenz.ch/v2018/widget?city=brienz')));
  });
}